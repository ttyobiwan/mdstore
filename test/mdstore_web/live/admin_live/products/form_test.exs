defmodule MdstoreWeb.AdminLive.Products.FormTest do
  ...
  describe "edit product form page" do
    ...
    test "updates existing product", %{conn: conn} do
      ...
      updated_product = Mdstore.Products.get_product(product.id)
      assert updated_product.name == "new name"
      assert updated_product.front_image.id != original_image_id
      assert Mdstore.Repo.get(Mdstore.Files.Image, original_image_id) == nil
    end
  end
end
