defmodule Phxstore.Accounts do
  @moduledoc """
  ...
  alias Phxstore.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Phxstore.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Phxstore.Accounts.User.password_changeset/3` for a list of supported options.
