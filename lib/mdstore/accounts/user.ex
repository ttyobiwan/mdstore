defmodule Mdstore.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Mdstore.Repo)
  ...
  """
  def valid_password?(%Mdstore.Accounts.User{hashed_password: hashed_password}, password)
