defmodule MdstoreWeb.Layouts do
  ...
  def simple_theme_toggle(assigns) do
    ~H"""
    <%!-- It's actually a little fucked, because we always start with the sun, but whatever --%>
    <label class="swap swap-rotate">
      <input type="checkbox" phx-click={JS.dispatch("phx:set-theme", detail: %{theme: "toggle"})} />
